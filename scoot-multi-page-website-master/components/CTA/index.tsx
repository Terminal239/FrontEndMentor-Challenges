...
const CTA = () => {
  return (
    <section className="cta">
        ...
        <div className="actions">
          <svg xmlns="http://www.w3.org/2000/svg" width={159} height={56}>
            <g fill="none" fillRule="evenodd">
              ...
              <g fill="#495567" fontFamily="SpaceMono-Bold, Space Mono" fontWeight="bold">
      ...
      <svg className="pattern pattern-dots" xmlns="http://www.w3.org/2000/svg" width="1158" height="158">
        <g fill="black" fillRule="evenodd" opacity=".1" transform="matrix(-1 0 0 1 1159 8)">
          <circle cx="173.5" cy="173.5" r="173.5" fill="#E5ECF4" />
          <circle cx="576.5" cy="173.5" r="173.5" stroke="#E5ECF4" strokeWidth="15" />
          <circle cx="979.5" cy="173.5" r="173.5" stroke="#E5ECF4" strokeWidth="15" />
        </g>
      </svg>
    </section>
  );
